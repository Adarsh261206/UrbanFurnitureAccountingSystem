...
export const Route = createFileRoute("/_app/purchase-orders/new")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "New purchase order in the Urban Furniture Accounting System." },
      { property: "og:title", content: "New purchase order — Urban Furniture Accounting" },
      { property: "og:description", content: "New purchase order in the Urban Furniture Accounting System." },
    ],
  }),
  component: () => (
...
function Page() {
  ...
  const loading =
    contactsQuery.isLoading || productsQuery.isLoading || accountsQuery.isLoading || analyticalsQuery.isLoading;
